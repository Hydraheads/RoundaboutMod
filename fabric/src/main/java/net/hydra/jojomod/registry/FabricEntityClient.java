...
public class FabricEntityClient {
    ...
    public static void register() {
        ...
        EntityRendererRegistry.register(FabricEntities.THE_GRATEFUL_DEAD, TheGratefulDeadRenderer::new);
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityRendererClient.THE_GRATEFUL_DEAD_LAYER, TheGratefulDeadModel::getTexturedModelData);
