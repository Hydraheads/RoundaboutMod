...
public class ForgeCooldownSyncPacket {
    ...
    public ForgeCooldownSyncPacket(int attackTime, int attackTimeMax, int attackTimeDuring, byte activePower, byte activePowerPhase){
    ...
    public ForgeCooldownSyncPacket(FriendlyByteBuf buf){
