...
public class ForgeItems {
    ...
    public static final RegistryObject<Item> STAND_DISC_GRATEFUL_DEAD = addToWIPTab(ITEMS.register("grateful_dead_disc",
            () -> new StandDiscItem(new Item.Properties().stacksTo(1), new PowersGratefulDead(null))));
    public static final RegistryObject<Item> MAX_STAND_DISC_GRATEFUL_DEAD = addToWIPTab(ITEMS.register("max_grateful_dead_disc",
