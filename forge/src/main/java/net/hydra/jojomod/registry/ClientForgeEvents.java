...
public class ClientForgeEvents {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ForgeEntities.THE_GRATEFUL_DEAD.get(), GratefulDeadRenderer::new);
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModEntityRendererClient.THE_GRATEFUL_DEAD_LAYER, GratefulDeadModel::getTexturedModelData);
