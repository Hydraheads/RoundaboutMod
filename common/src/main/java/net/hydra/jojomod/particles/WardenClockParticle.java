...
public class WardenClockParticle extends SimpleAnimatedParticle {
    WardenClockParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, SpriteSet spriteSet) {
        ...
        this.lifetime = (int)(3.0 / (Math.random() * 0.8 + 0.2)) + 16;
    ...
    public static class Provider
        ...
        public Particle createParticle(SimpleParticleType $$0, ClientLevel $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
            return new WardenClockParticle($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.sprites);
        }
    }
}
