...
public class RoadRollerExplosionParticle extends TextureSheetParticle {

    protected RoadRollerExplosionParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new RoadRollerExplosionParticle(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
