...
public class CinderellaSmokeParticle extends TextureSheetParticle {
    CinderellaSmokeParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, boolean bl) {
    ...
    public static class CosyProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i) {
            CinderellaSmokeParticle campfireSmokeParticle = new CinderellaSmokeParticle(clientLevel, d, e, f, g, h, i, false);
