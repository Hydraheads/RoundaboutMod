...
public class UVSparkleParticle extends SimpleAnimatedParticle {
    private final SpriteSet sprites;

    protected UVSparkleParticle(ClientLevel $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, SpriteSet $$7) {
        super($$0, $$1, $$2, $$3, $$7, 1f);
        this.age = 0;
        this.lifetime = 14;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType $$0, ClientLevel $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
            UVSparkleParticle part = new UVSparkleParticle($$1, $$2, $$3, $$4, $$5,$$6,$$7, this.sprites);
