...
public class PunchMissParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected PunchMissParticle(ClientLevel $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, SpriteSet $$7) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType $$0, ClientLevel $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
            PunchMissParticle part = new PunchMissParticle($$1, $$2, $$3, $$4, $$5,$$6,$$7, this.sprites);
