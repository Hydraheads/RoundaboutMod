...
public class BloodMistParticle extends TextureSheetParticle {
    BloodMistParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, boolean bl) {
    ...
    public static class CosyProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double d, double e, double f, double g, double h, double i) {
            BloodMistParticle campfireSmokeParticle = new BloodMistParticle(clientLevel, d, e, f, g, h, i, false);
