...
public class ModGamerules {
    ...
    public static GameRules.Key<GameRules.BooleanValue> ROUNDABOUT_STAND_GRIEFING_OBTAINMENT;
    public static GameRules.Key<GameRules.BooleanValue> ROUNDABOUT_MOB_STAND_FIRE_SPREADS;
