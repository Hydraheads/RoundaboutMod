...
public class KiraPartEightVisage extends VisageData {
    public KiraPartEightVisage(LivingEntity self) {
        super(self);
    }
    public VisageData generateVisageData(LivingEntity entity){
        return new KiraPartEightVisage(entity);
    }
    /*@Override
