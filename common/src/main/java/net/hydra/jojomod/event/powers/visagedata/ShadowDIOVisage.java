...
public class ShadowDIOVisage extends VisageData {
    public ShadowDIOVisage(LivingEntity self) {
        super(self);
    }
    public VisageData generateVisageData(LivingEntity entity){
        return new ShadowDIOVisage(entity);
    }
    @Override
    public JojoNPC getModelNPC(LivingEntity pl){
        JojoNPC jojoNPC = ModEntities.DIO.create(pl.level());
        if (jojoNPC !=null){
            jojoNPC.setTrueBasis(ModItems.SHADOW_DIO_MASK.getDefaultInstance());
        }
        return jojoNPC;
    }
    @Override
