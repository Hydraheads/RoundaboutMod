...
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ratt"), "main");
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head = stand2.addOrReplaceChild("head", CubeListBuilder.create().texOffs(5, 5).addBox(-3.0F, -9.0F, -3.5F, 6.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(1, 1).addBox(-3.0F, -2.1F, -2.5F, 6.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.5F));
        ...
        PartDefinition willie_hat = head2.addOrReplaceChild("willie_hat", CubeListBuilder.create().texOffs(60, 71).addBox(-2.5F, -2.9F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(-1.2F)), PartPose.offset(-0.195F, -1.515F, -1.485F));
