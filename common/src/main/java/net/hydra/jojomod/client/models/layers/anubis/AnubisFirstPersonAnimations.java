...
public class AnubisFirstPersonAnimations {
    ...
    public static final AnimationDefinition SneakAttack = AnimationDefinition.Builder.withLength(0.5F)
            .addAnimation("stand", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition SneakAttack2 = AnimationDefinition.Builder.withLength(0.5F)
            .addAnimation("stand", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition DoubleCut = AnimationDefinition.Builder.withLength(0.5F)
            .addAnimation("stand", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.35415F, KeyframeAnimations.degreeVec(55.6817F, -29.1526F, -83.0422F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("stand", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.35415F, KeyframeAnimations.posVec(0.0F, 0.0F, -30.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
