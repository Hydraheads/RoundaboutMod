...
public class NonJojoNPCItemInHandLayer<T extends LivingEntity, M extends NonJojoNpcModel<T> & ArmedModel & HeadedModel> extends ItemInHandLayer<T, M> {
    ...
    public NonJojoNPCItemInHandLayer(RenderLayerParent<T, M> $$0, ItemInHandRenderer $$1) {
        super($$0, $$1);
