...
public class BlackSabbathRenderer extends BlackSabbathBaseRenderer {

    public BlackSabbathRenderer(EntityRendererProvider.Context context) {
        super(context, new BlackSabbathModel<>(context.bakeLayer(ModEntityRendererClient.BLACK_SABBATH_LAYER)), 0f);
    }
