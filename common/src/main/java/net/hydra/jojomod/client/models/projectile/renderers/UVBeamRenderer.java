...
public class UVBeamRenderer extends EntityRenderer<UltravioletProjectile> {

    private final UVModel model;

    public UVBeamRenderer(EntityRendererProvider.Context $$0) {
        super($$0);
        this.model = new UVModel<>($$0.bakeLayer(ModEntityRendererClient.UV_LAYER));
    }


    public void render(UltravioletProjectile $$0, float $$1, float $$2, PoseStack $$3, MultiBufferSource $$4, int $$5) {
    ...
    @Override
    public ResourceLocation getTextureLocation(UltravioletProjectile var1) {
        return new ResourceLocation(Roundabout.MOD_ID, "textures/entity/projectile/uv.png");
    }
