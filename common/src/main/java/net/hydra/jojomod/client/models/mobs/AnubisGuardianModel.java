...
public class AnubisGuardianModel<T extends AnubisGuardian> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public AnubisGuardianModel(ModelPart p_170688_) {
        this.root = p_170688_;
