...
public class EyebrowRattModel<T extends RattEntity> extends StandModel<T> {
	...
	private final ModelPart Berrel3;
	...
	public EyebrowRattModel(ModelPart root) {
		...
		this.Barrel2 = this.Barrel.getChild("Barrel2");
		this.Berrel3 = this.Barrel2.getChild("Berrel3");
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition head = stand2.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -7.0F, -3.5F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, 0.5F));

		PartDefinition eyebrow_r1 = head.addOrReplaceChild("eyebrow_r1", CubeListBuilder.create().texOffs(1, 2).addBox(-2.0F, -1.0F, -0.6F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.2F, -4.0F, -3.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition eyebrow_r2 = head.addOrReplaceChild("eyebrow_r2", CubeListBuilder.create().texOffs(1, 2).addBox(-2.0F, -1.0F, -0.6F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.2F, -4.0F, -3.0F, 0.0F, 0.0F, -0.1309F));
		...
		PartDefinition Jaw = head.addOrReplaceChild("Jaw", CubeListBuilder.create().texOffs(44, 6).addBox(-2.5F, -2.0787F, -2.8198F, 5.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, -0.5F));
		...
		PartDefinition Barrel = head.addOrReplaceChild("Barrel", CubeListBuilder.create(), PartPose.offset(0.0F, -3.0F, 2.0F));

		PartDefinition Berrel2 = Barrel.addOrReplaceChild("Berrel2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.25F, 10.0F));

		PartDefinition Barrel2 = Barrel.addOrReplaceChild("Barrel2", CubeListBuilder.create().texOffs(24, 10).addBox(-0.5F, 1.25F, 0.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(0, 14).addBox(-1.0F, -0.75F, 0.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Berrel3 = Barrel2.addOrReplaceChild("Berrel3", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -0.5F, -6.0F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.25F, 10.0F));
