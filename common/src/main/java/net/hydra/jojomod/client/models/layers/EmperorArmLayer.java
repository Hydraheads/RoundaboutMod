...
import java.util.Map;
    ...
    public class EmperorArmLayer <T extends LivingEntity, A extends HumanoidModel<T>> extends RenderLayer<T, A> {
        private static final Map<String, ResourceLocation> ARMOR_LOCATION_CACHE = Maps.newHashMap();
        private final EntityRenderDispatcher dispatcher;
        public EmperorArmLayer(EntityRendererProvider.Context context, LivingEntityRenderer<T, A> livingEntityRenderer) {
                ...
                if (!entity.isInvisible()) {
                    if (entity!= null) {
                        ...
                        if (user.roundabout$getCombatMode() && PowerTypes.hasStandActivelyEquipped(entity)) {
                            if (user.roundabout$getStandPowers() instanceof PowersEmperor PW) {
                                ...
                                ModStrayModels.EMPEROR_SHOOTING_ARM.render(livent, partialTicks, poseStack, bufferSource, packedLight, r, g, b, 0.8F);
                ...
                if (entity!= null) {
                    ...
                    if (user.roundabout$getCombatMode() && PowerTypes.hasStandActivelyEquipped(entity)) {
                        if (user.roundabout$getStandPowers() instanceof PowersEmperor PW) {
                            ...
                            float g = isHurt ? 0.0F : 1.0F;
                            float b = isHurt ? 0.0F : 1.0F;
                            ModStrayModels.EMPEROR_MODEL.render(entity, partialTicks, poseStack, bufferSource, packedLight, rr, gg, bb, 0.8F);
