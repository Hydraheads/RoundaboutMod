...
public class OasisSlimRightArmPart extends PsuedoHierarchicalModel {
   ...
   private final ModelPart limb;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition limb = partdefinition.addOrReplaceChild("limb", CubeListBuilder.create().texOffs(80, 41).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F))
                .texOffs(79, 57).addBox(-2.0F, -2.1F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)), PartPose.offset(0.0F, 0.0F, 0.0F));
