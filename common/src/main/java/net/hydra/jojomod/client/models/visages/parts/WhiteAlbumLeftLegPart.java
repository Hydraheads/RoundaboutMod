...
public class WhiteAlbumLeftLegPart extends PsuedoHierarchicalModel {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
   private final ModelPart limb;
    private final ModelPart Root;

    public WhiteAlbumLeftLegPart() {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition limb2 = partdefinition.addOrReplaceChild("limb", CubeListBuilder.create().texOffs(40, 42).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.26F))
                .texOffs(56, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.35F)), PartPose.offset(0.0F, 0.0F, 0.0F));
