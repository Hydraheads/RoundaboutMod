...
public class BlackSantaSabbathModel <T extends BlackSantaSabbathEntity> extends StandModel<T>{
    ...
    public BlackSantaSabbathModel(ModelPart root) {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head2 = head.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(32, 32).addBox(-4.0F, -7.85F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(96, 0).addBox(-4.0F, -7.85F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.25F))
                .texOffs(0, 118).addBox(-4.5F, -2.85F, -4.25F, 9.0F, 2.0F, 8.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition hat_r1 = hat.addOrReplaceChild("hat_r1", CubeListBuilder.create().texOffs(9, 6).addBox(-2.5F, -1.5F, -3.5F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, -0.6F, 0.1841F, 0.7769F, 0.1298F));

        PartDefinition hat_r2 = hat.addOrReplaceChild("hat_r2", CubeListBuilder.create().texOffs(19, 113).addBox(-1.5F, -1.5F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -9.25F, 2.0F, -0.5571F, 0.699F, -0.3587F));

        PartDefinition hat_r3 = hat.addOrReplaceChild("hat_r3", CubeListBuilder.create().texOffs(12, 8).addBox(-1.5F, -2.5F, -2.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.75F, 0.0F, -0.5571F, 0.699F, -0.3587F));

        PartDefinition hat_r4 = hat.addOrReplaceChild("hat_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-5.5F, -2.5F, -6.5F, 12.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
