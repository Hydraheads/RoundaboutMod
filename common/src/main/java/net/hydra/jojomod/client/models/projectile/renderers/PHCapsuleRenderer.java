...
public class PHCapsuleRenderer extends EntityRenderer<PHCapsuleEntity> {
    ...
    private static final ResourceLocation POD = new ResourceLocation(Roundabout.MOD_ID, "textures/stand/purple_haze/pod.png");
    ...
    private static final ResourceLocation POD2 = new ResourceLocation(Roundabout.MOD_ID, "textures/stand/purple_haze/pod2.png");

    private final float scale;

    public PHCapsuleRenderer(EntityRendererProvider.Context context, float scale) {
        super(context);
        this.scale = scale;
    }

    public PHCapsuleRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.scale = 1f;
    }

    @Override
    public void render(PHCapsuleEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(PHCapsuleEntity entity) {
     return POD;
