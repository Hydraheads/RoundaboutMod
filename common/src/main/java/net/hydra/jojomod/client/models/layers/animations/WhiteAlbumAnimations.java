...
public class WhiteAlbumAnimations {
    ...
    public static final AnimationDefinition SpinningBubble = AnimationDefinition.Builder.withLength(0.5F).looping()
            .addAnimation("arm_addon", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 0, -180.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0, -360.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();
}
