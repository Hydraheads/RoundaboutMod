...
public class BeachSabbathModel<T extends BeachSabbathEntity> extends StandModel<T> {
	...
	public BeachSabbathModel(ModelPart root) {
	...
	public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition hat_r1 = hat.addOrReplaceChild("hat_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-5.5F, 0.5F, -6.5F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1841F, 0.7769F, 0.1298F));

        PartDefinition hat_core_r1 = hat.addOrReplaceChild("hat_core_r1", CubeListBuilder.create().texOffs(5, 4).addBox(9.0F, -2.0F, -5.0F, 7.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 2.0F, 12.0F, 0.0F, 1.5708F, 0.0F));

        PartDefinition spheres_r1 = hat.addOrReplaceChild("spheres_r1", CubeListBuilder.create().texOffs(80, 39).addBox(-5.5F, -2.5F, -6.5F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.1841F, 0.7769F, 0.1298F));
