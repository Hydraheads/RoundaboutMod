...
//                    //ELA.getModel().setupAnim((AbstractClientPlayer) $$0, 0, 0, $$4 %1, $$8, $$11);
        ...
        if (cameraEnt instanceof Player play) {
            ...
            if (play.getUseItem().getItem() instanceof SnubnoseRevolverItem && !play.getCooldowns().isOnCooldown(play.getUseItem().getItem())) {
                ...
                stack.popPose();
            } else if ((!(play.getUseItem().getItem() instanceof SnubnoseRevolverItem) && play.getMainHandItem().getItem() instanceof SnubnoseRevolverItem || play.getOffhandItem().getItem() instanceof SnubnoseRevolverItem)) {
                stack.pushPose();
