...
public class DiverDownWorkbenchSelect extends Screen implements NoCancelInputScreen {
     ...
     * 
     * @double $$0 is an indicator for the x coordinate of the mouse
     * @double $$1 is an indicator for the y coordinate of the mouse
     * @int $$2 indicates what mouse button was clicked. 0 is for left click, 1 is for right.
