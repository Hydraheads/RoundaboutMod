...
public class SoftAndWetKingModel<T extends SoftAndWetEntity> extends StandModel<T> {
    public SoftAndWetKingModel(ModelPart root) {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition extra_details = head2.addOrReplaceChild("extra_details", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, 5.9886F, -5.0302F, 8.0F, 2.8F, 8.0F, new CubeDeformation(0.2F))
                .texOffs(0, 16).addBox(-4.0F, 0.7886F, -5.0302F, 8.0F, 4.8F, 8.0F, new CubeDeformation(0.2F))
                ...
                .texOffs(33, 95).addBox(-4.0F, -2.2114F, -5.0302F, 8.0F, 5.0F, 8.0F, new CubeDeformation(0.25F))
                .texOffs(75, 18).addBox(-1.725F, 5.0261F, -5.0302F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.01F))
                ...
                .texOffs(75, 18).addBox(2.075F, 5.0261F, -5.0302F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, -8.8761F, 1.0302F));
        ...
        PartDefinition cape_r1 = upper_chest_only.addOrReplaceChild("cape_r1", CubeListBuilder.create().texOffs(74, 84).addBox(-4.5F, -7.8F, -1.5F, 9.0F, 16.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.6F, 2.5F, 3.0107F, 0.0F, 3.1416F));
