...
public class TheWorldModel<T extends TheWorldEntity> extends StandModel<T> {
	...
	public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition tanks = no_arms.addOrReplaceChild("tanks", CubeListBuilder.create().texOffs(65, 64).addBox(-3.5F, -23.0F, 2.0F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.01F))
                .texOffs(41, 65).addBox(0.5F, -23.0F, 2.0F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.01F))
                .texOffs(24, 27).addBox(-4.0F, -24.0F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 18.0F, 0.0F));

        PartDefinition upper_straps = no_arms.addOrReplaceChild("upper_straps", CubeListBuilder.create().texOffs(16, 37).addBox(-3.9F, -24.001F, -3.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.01F))
                .texOffs(0, 37).addBox(1.9F, -24.001F, -3.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 18.0F, 0.0F));
