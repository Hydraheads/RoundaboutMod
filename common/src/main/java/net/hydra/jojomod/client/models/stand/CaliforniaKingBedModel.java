...
public class CaliforniaKingBedModel<T extends CaliforniaKingBedEntity> extends StandModel<T>{
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.animate(pEntity.idleAnimationState, KingBedAnimations.Normal, pAgeInTicks, 1f);
        this.animate(pEntity.idleAnimationState2, KingBedAnimations.Whimsical, pAgeInTicks, 1f);
    }
