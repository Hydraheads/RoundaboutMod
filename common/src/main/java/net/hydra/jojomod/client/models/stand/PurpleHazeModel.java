...
public class PurpleHazeModel<T extends PurpleHazeEntity> extends StandModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition RightArmBAM = BAM.addOrReplaceChild("RightArmBAM", CubeListBuilder.create(), PartPose.offset(-11.5F, -8.0F, 0.0F));
        ...
        PartDefinition LeftArmBAM = BAM.addOrReplaceChild("LeftArmBAM", CubeListBuilder.create(), PartPose.offset(11.5F, -8.0F, 0.0F));
