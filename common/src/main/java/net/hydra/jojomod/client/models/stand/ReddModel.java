...
//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ratt"), "main");
	...
	public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition Barrel2 = Barrel.addOrReplaceChild("Barrel2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition eyebrow_r1 = eyebrows.addOrReplaceChild("eyebrow_r1", CubeListBuilder.create().texOffs(33, 63).addBox(-2.0F, -1.0F, -0.6F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.2F, -4.0F, -3.0F, 0.0F, 0.0F, -0.1309F));
