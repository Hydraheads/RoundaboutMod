...
public class BasicHatPart extends PsuedoHierarchicalModel {
   ...
   private final ModelPart hat;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = hat.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, -3.0F, -2.0F, 10.0F, 1.0F, 3.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-0.975F, -2.6F, -4.0F, 0.2618F, 0.0F, 0.0F));
