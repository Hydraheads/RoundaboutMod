...
public class StarPlatinumModel<T extends StarPlatinumEntity> extends StandModel<T> {
	...
	public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition upper_chest_only = upper_chest.addOrReplaceChild("upper_chest_only", CubeListBuilder.create().texOffs(30, 18).addBox(-4.5F, -7.0F, -2.5F, 9.0F, 4.0F, 5.0F, new CubeDeformation(0.01F))
                .texOffs(0, 43).addBox(-4.0F, -6.0F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 0.0F, 0.0F));
