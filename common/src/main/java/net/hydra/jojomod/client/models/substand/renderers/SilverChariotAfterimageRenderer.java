...
import net.hydra.jojomod.client.models.substand.SilverChariotAfterimageModel;
import net.hydra.jojomod.entity.stand.StandEntity;
import net.hydra.jojomod.entity.substand.SilverChariotAfterimageEntity;
...
public class SilverChariotAfterimageRenderer<T extends StandEntity> extends StandRenderer<SilverChariotAfterimageEntity> {
    ...
    public SilverChariotAfterimageRenderer(EntityRendererProvider.Context context) {
        super(context, new SilverChariotAfterimageModel<>(context.bakeLayer(ModEntityRendererClient.SILVER_CHARIOT_AFTERIMAGE_LAYER)), 0f);
    }

    @Override
    public ResourceLocation getTextureLocation(SilverChariotAfterimageEntity entity) {
    ...
    @Override
    public void render(SilverChariotAfterimageEntity mobEntity, float f, float g, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i) {
    ...
    @Nullable
    @Override
    protected RenderType getRenderType(SilverChariotAfterimageEntity entity, boolean showBody, boolean translucent, boolean showOutline) {
