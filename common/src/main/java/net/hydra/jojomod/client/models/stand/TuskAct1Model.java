...
public class TuskAct1Model<T extends TuskEntity> extends StandModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition torso2 = torso.addOrReplaceChild("torso2", CubeListBuilder.create().texOffs(24, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(39, 6).addBox(-1.5F, 2.0F, 0.0F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 0.0F));

        PartDefinition cube_r1 = torso2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(38, 4).addBox(-2.5F, -1.0F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 0.5F, 0.0F, -1.5708F, 0.0F));

        PartDefinition flaps = torso2.addOrReplaceChild("flaps", CubeListBuilder.create(), PartPose.offset(-3.0F, 1.0F, -1.25F));

        PartDefinition flapFL = flaps.addOrReplaceChild("flapFL", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r2 = flapFL.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(15, 24).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, 0.0F, 0.0F, 0.0233F, 0.2608F, 0.0903F));

        PartDefinition flapFR = flaps.addOrReplaceChild("flapFR", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r3 = flapFR.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(24, 21).addBox(-1.5F, -1.5F, 0.0F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, 0.5F, 2.25F, -0.0038F, 0.0872F, -0.0438F));

        PartDefinition flapBL = flaps.addOrReplaceChild("flapBL", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r4 = flapBL.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(23, 18).addBox(-2.5F, -1.5F, 0.0F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.75F, 0.5F, 2.25F, -0.0038F, -0.0872F, 0.0438F));
        ...
        PartDefinition earRight_r1 = head.addOrReplaceChild("earRight_r1", CubeListBuilder.create().texOffs(16, 40).addBox(-2.0F, -2.0F, 0.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(34, 36).addBox(7.0F, -2.0F, 0.0F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -3.75F, 0.25F, 0.4363F, 0.0F, 0.0F));
        ...
        PartDefinition faceThings = head.addOrReplaceChild("faceThings", CubeListBuilder.create().texOffs(30, 18).addBox(-6.0F, -28.0F, -2.0F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 32).addBox(-6.0F, -27.0F, -3.75F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 1.0F));
