...
public class FirearmFirstPersonAnimations {
    public static final AnimationDefinition snubnose_aim = AnimationDefinition.Builder.withLength(0.125F)
            .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(-14.0F, 9.0F, -4.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.125F, KeyframeAnimations.posVec(-7.0F, 0.0F, -2.0F), AnimationChannel.Interpolations.LINEAR)
            ))
