...
public class FirearmFirstPersonAnimations {
    ...
    public static final AnimationDefinition tommy_model_aim_left = AnimationDefinition.Builder.withLength(0.0F).looping()
            .addAnimation("TommyGun", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F,
    ...
    public static final AnimationDefinition tommy_recoil_left = AnimationDefinition.Builder.withLength(0.125F)
    ...
    public static final AnimationDefinition tommy_model_recoil_left = AnimationDefinition.Builder.withLength(0.125F)
            .addAnimation("TommyGun", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 180.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0417F, KeyframeAnimations.degreeVec(-2.5F, 0.0F, 180.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.125F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 180.0F), AnimationChannel.Interpolations.LINEAR)
    ...
    public static final AnimationDefinition colt_model_aim = AnimationDefinition.Builder.withLength(0.0F).looping()
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-0.2476F, -2.5F, -180.0278F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(4.0F, 30.0F, -14.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();

    public static final AnimationDefinition colt_model_recoil = AnimationDefinition.Builder.withLength(0.25F)
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-0.2476F, -2.5F, 180.0278F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0417F, KeyframeAnimations.degreeVec(-10.7524F, -2.5F, 180.0278F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(-0.2476F, -2.5F, 180.0278F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(4.0F, 30.0F, -14.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0417F, KeyframeAnimations.posVec(4.0F, 28.5F, -14.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.25F, KeyframeAnimations.posVec(4.0F, 30.0F, -14.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();

    public static final AnimationDefinition colt_model_aim_left = AnimationDefinition.Builder.withLength(0.0F)
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-0.2476F, 2.5F, 180.0278F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.POSITION,
    ...
    public static final AnimationDefinition colt_model_recoil_left = AnimationDefinition.Builder.withLength(0.25F)
            .addAnimation("ColtSAA", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-0.2476F, 2.5F, -180.0278F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0417F, KeyframeAnimations.degreeVec(-10.7524F, 2.5F, -180.0278F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(-0.2476F, 2.5F, -180.0278F), AnimationChannel.Interpolations.LINEAR)
