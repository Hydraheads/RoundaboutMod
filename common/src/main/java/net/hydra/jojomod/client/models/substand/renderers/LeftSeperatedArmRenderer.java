...
import net.hydra.jojomod.client.models.substand.LeftSeperatedArmModel;
...
public class LeftSeperatedArmRenderer extends StandRenderer<LeftSeperatedArmEntity> {
    ...
    public LeftSeperatedArmRenderer(EntityRendererProvider.Context context) {
        super(context, new LeftSeperatedArmModel<>(context.bakeLayer(ModEntityRendererClient.LEFT_SEPERATED_ARM_LAYER)), 0f);
    }


    @Override
    public ResourceLocation getTextureLocation(LeftSeperatedArmEntity seperatedArmSlimEntity) {
    ...
    @Override
    public void render(LeftSeperatedArmEntity mobEntity, float f, float g, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i) {
