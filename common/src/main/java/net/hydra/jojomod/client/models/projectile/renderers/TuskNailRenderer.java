...
public class TuskNailRenderer extends EntityRenderer<TuskNailEntity> {
    private final RattDartModel model;
    ...
    @Override
    public ResourceLocation getTextureLocation(TuskNailEntity tuskNailEntity) {return ModEntities.RATT_DART_TEXTURE;}

    public void render(TuskNailEntity $$0, float $$1, float $$2, PoseStack $$3, MultiBufferSource $$4, int $$5) {
