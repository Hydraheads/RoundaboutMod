...
public class MandomLayer<T extends LivingEntity, A extends HumanoidModel<T>> extends RenderLayer<T, A> {
    ...
    public static void renderWatchFirstPerson(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight,
                                              LivingEntity entity, float var5, float var6, float var7, float partialTicks,
