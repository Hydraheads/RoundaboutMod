...
public class ManhattanTransferModel<T extends ManhattanTransferEntity> extends StandModel<T> {
    ...
    private final ModelPart back_teeth;
    private final ModelPart left_teeth;
    private final ModelPart right_teeth;
    private final ModelPart front_teeth;
    ...
    public ManhattanTransferModel(ModelPart root) {
        ...
        this.front_teeth = stand.getChild("stand2").getChild("front_wing").getChild("front_flap").getChild("front_teeth");
        ...
        this.right_teeth = stand.getChild("stand2").getChild("right_wing").getChild("right_flap").getChild("right_teeth");
        ...
        this.left_teeth = stand.getChild("stand2").getChild("left_wing").getChild("left_flap").getChild("left_teeth");
        ...
        this.back_teeth = stand.getChild("stand2").getChild("back_wing").getChild("back_flap").getChild("back_teeth");
    ...
    public static LayerDefinition getTexturedModelData() {
       /* MeshDefinition meshdefinition = new MeshDefinition();
        ...
        PartDefinition mangacores = core.addOrReplaceChild("mangacores", CubeListBuilder.create().texOffs(25, 3).addBox(-1.5F, -4.5F, 1.6F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(25, 9).addBox(-1.5F, -4.5F, -3.6F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(-5, 0).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition key_string1 = stand2.addOrReplaceChild("key_string1", CubeListBuilder.create().texOffs(61, 7).addBox(1.0F, 0.0F, -1.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.5F, 0.0F));

        PartDefinition key = key_string1.addOrReplaceChild("key", CubeListBuilder.create().texOffs(60, 5).addBox(1.0F, 2.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(61, 6).addBox(1.5F, 3.0F, -2.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition key_string2 = stand2.addOrReplaceChild("key_string2", CubeListBuilder.create().texOffs(61, 7).addBox(1.0F, 0.0F, 1.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, 2.5F, 0.0F));

        PartDefinition key2 = key_string2.addOrReplaceChild("key2", CubeListBuilder.create().texOffs(60, 5).addBox(1.0F, 2.0F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(61, 6).addBox(1.5F, 3.0F, 1.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition front_wing_r1 = front_flap.addOrReplaceChild("front_wing_r1", CubeListBuilder.create().texOffs(36, 28).addBox(-3.0F, -1.0F, -8.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, 0.1309F, 0.0F, 0.0F));

        PartDefinition front_teeth = front_flap.addOrReplaceChild("front_teeth", CubeListBuilder.create(), PartPose.offset(0.0F, 1.2503F, -7.7865F));

        PartDefinition frt_teth_r1 = front_teeth.addOrReplaceChild("frt_teth_r1", CubeListBuilder.create().texOffs(43, 8).addBox(-3.5F, -2.5005F, -0.0218F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -2.8798F, 0.0F, 0.0F));
        ...
        PartDefinition right_teeth = right_flap.addOrReplaceChild("right_teeth", CubeListBuilder.create(), PartPose.offset(-0.5F, 1.0F, -10.0F));

        PartDefinition rai_teth_r1 = right_teeth.addOrReplaceChild("rai_teth_r1", CubeListBuilder.create().texOffs(43, 8).addBox(-3.0F, -3.0F, -1.0F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -2.8798F, 0.0F, 0.0F));
        ...
        PartDefinition left_teeth = left_flap.addOrReplaceChild("left_teeth", CubeListBuilder.create(), PartPose.offset(-0.5F, 1.0F, -8.0F));

        PartDefinition lf_teth_r1 = left_teeth.addOrReplaceChild("lf_teth_r1", CubeListBuilder.create().texOffs(43, 8).addBox(-3.0F, -3.0F, -1.0F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -2.8798F, 0.0F, 0.0F));
        ...
        PartDefinition back_teeth = back_flap.addOrReplaceChild("back_teeth", CubeListBuilder.create(), PartPose.offset(0.0F, 1.2503F, -7.7865F));

        PartDefinition bak_teth_r1 = back_teeth.addOrReplaceChild("bak_teth_r1", CubeListBuilder.create().texOffs(43, 8).addBox(-3.5F, -2.5005F, -0.0218F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -2.8798F, 0.0F, 0.0F));
