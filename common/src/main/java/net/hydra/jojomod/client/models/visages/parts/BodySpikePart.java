...
public class BodySpikePart extends PsuedoHierarchicalModel {
   ...
   private final ModelPart body_spikes;
    ...
    public BodySpikePart() {
        ...
        this.spike11 = this.body_spikes.getChild("spike11");
        this.spike12 = this.body_spikes.getChild("spike12");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition spike5 = body_spikes.addOrReplaceChild("spike5", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0998F, -1.9866F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0922F, 0.668F, -0.96F, 2.2631F, 0.0F, -3.1416F));
        ...
        PartDefinition spike8 = body_spikes.addOrReplaceChild("spike8", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0427F, -1.0011F, -1.9953F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.6513F, 2.3889F, -2.0127F, -0.2795F, 0.0792F, 0.4052F));
        ...
        PartDefinition spike10 = body_spikes.addOrReplaceChild("spike10", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0427F, -1.0011F, -1.9953F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.6513F, 4.3889F, -2.0127F, 0.4186F, 0.0792F, 0.4052F));
    ...
    public void render(Entity context, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource,
        ...
        if (context instanceof LivingEntity LE) {
            ...
            if (context instanceof Player pl && ((IPowersPlayer)pl).rdbt$getPowers() instanceof VampireGeneralPowers gp){
                ...
                modifySpike(spike11,partial,tier2);
                modifySpike(spike12,partial,tier2);
