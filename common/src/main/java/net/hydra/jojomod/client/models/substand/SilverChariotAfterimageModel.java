...
public class SilverChariotAfterimageModel<T extends SilverChariotAfterimageEntity> extends StandModel<T> {
	...
	public SilverChariotAfterimageModel(ModelPart root) {
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		// this.animate(pEntity.scBlock, SilverChariotAfterimageAnimations.Block, pAgeInTicks, 1f);
		// this.animate(pEntity.scBarrage, SilverChariotAfterimageAnimations.Barrage, pAgeInTicks, 1f);
		// this.animate(pEntity.scBarrageDamage, SilverChariotAfterimageAnimations.BarrageDamage, pAgeInTicks, 1f);
		// this.animate(pEntity.scBarrageCharge, SilverChariotAfterimageAnimations.BarrageCharge, pAgeInTicks, 1f);
		// this.animate(pEntity.scFallBrace, SilverChariotAfterimageAnimations.FallBrace, pAgeInTicks, 1f);
	}
