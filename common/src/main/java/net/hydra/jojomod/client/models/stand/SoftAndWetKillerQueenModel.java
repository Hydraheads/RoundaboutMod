...
import net.hydra.jojomod.client.models.stand.animations.*;
...
public class SoftAndWetKillerQueenModel<T extends SoftAndWetEntity> extends StandModel<T>{
    public SoftAndWetKillerQueenModel(ModelPart root) {
