...
public class IceTwisterRenderer extends EntityRenderer<IceTwisterEntity> {
    ...
    private final IceTwisterModel model;

    public IceTwisterRenderer(EntityRendererProvider.Context $$0) {
        super($$0);
        this.model = new IceTwisterModel<>($$0.bakeLayer(ModEntityRendererClient.ICE_TWISTER_LAYER));
    }
    ...
    @Override
    public ResourceLocation getTextureLocation(IceTwisterEntity var1) {
