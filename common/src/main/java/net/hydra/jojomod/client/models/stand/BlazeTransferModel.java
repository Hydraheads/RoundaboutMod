...
import net.hydra.jojomod.client.models.stand.animations.BlazeTransferAnimations;
...
import net.hydra.jojomod.entity.stand.BlazeTransferEntity;
...
public class BlazeTransferModel<T extends BlazeTransferEntity> extends StandModel<T>  {
    ...
    public BlazeTransferModel(ModelPart root) {
        ...
        this.center = stand.getChild("stand2").getChild("core").getChild("center");

        this.back = stand.getChild("stand2").getChild("core").getChild("center").getChild("back");
        this.front = stand.getChild("stand2").getChild("core").getChild("center").getChild("front");
        this.left = stand.getChild("stand2").getChild("core").getChild("center").getChild("left");
        this.right = stand.getChild("stand2").getChild("core").getChild("center").getChild("right");
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition center = core.addOrReplaceChild("center", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition back = center.addOrReplaceChild("back", CubeListBuilder.create(), PartPose.offset(0.0F, -0.6058F, 6.2127F));

        PartDefinition back_wing_r1 = back.addOrReplaceChild("back_wing_r1", CubeListBuilder.create().texOffs(36, 46).addBox(-3.0F, -0.5F, -8.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

        PartDefinition front = center.addOrReplaceChild("front", CubeListBuilder.create().texOffs(36, 28).addBox(-3.0F, -0.5F, -8.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.6058F, -6.2127F));

        PartDefinition left = center.addOrReplaceChild("left", CubeListBuilder.create(), PartPose.offset(6.2127F, -0.6058F, 0.0F));

        PartDefinition left_wing_r1 = left.addOrReplaceChild("left_wing_r1", CubeListBuilder.create().texOffs(36, 55).addBox(-3.0F, -0.5F, -8.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        PartDefinition right = center.addOrReplaceChild("right", CubeListBuilder.create(), PartPose.offset(-6.2127F, -0.6058F, 0.0F));

        PartDefinition right_wing_r1 = right.addOrReplaceChild("right_wing_r1", CubeListBuilder.create().texOffs(36, 37).addBox(-3.0F, -0.5F, -8.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
        ...
        PartDefinition manga_petal_r1 = back_manga.addOrReplaceChild("manga_petal_r1", CubeListBuilder.create().texOffs(43, 12).addBox(-3.5F, -2.5043F, -0.0653F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1082F, 0.4882F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition manga_petal_r2 = left_manga.addOrReplaceChild("manga_petal_r2", CubeListBuilder.create().texOffs(43, 12).addBox(-3.5F, -2.5005F, -0.0218F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1082F, 0.4882F, -0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition manga_petal_r3 = right_manga.addOrReplaceChild("manga_petal_r3", CubeListBuilder.create().texOffs(43, 12).mirror().addBox(-3.5F, -2.5005F, -0.0218F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -0.1082F, 0.4882F, -0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition manga_petal_r4 = front_manga.addOrReplaceChild("manga_petal_r4", CubeListBuilder.create().texOffs(43, 12).addBox(-3.5F, -2.5005F, -0.0218F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1082F, 0.4882F, -0.0436F, 0.0F, 0.0F));
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.animate(pEntity.blazehattan_is_loaded, BlazeTransferAnimations.Idle, pAgeInTicks, 1f);
        this.animate(pEntity.rain_dodging_blazehattan, BlazeTransferAnimations.Rain_Dodge, pAgeInTicks, 1f);
        this.animate(pEntity.forward_blazehattan_incipit, BlazeTransferAnimations.Forward_North, pAgeInTicks, 1f);
        this.animate(pEntity.back_blazehattan_incipit, BlazeTransferAnimations.Forward_South, pAgeInTicks, 1f);
        this.animate(pEntity.left_blazehattan_incipit, BlazeTransferAnimations.Lateral_West, pAgeInTicks, 1f);
        this.animate(pEntity.right_blazehattan_incipit, BlazeTransferAnimations.Lateral_East, pAgeInTicks, 1f);
        this.animate(pEntity.forward_blazehattan_stop, BlazeTransferAnimations.Forward_North_Stop, pAgeInTicks, 1f);
        this.animate(pEntity.back_blazehattan_stop, BlazeTransferAnimations.Forward_South_Stop, pAgeInTicks, 1f);
        this.animate(pEntity.left_blazehattan_stop, BlazeTransferAnimations.Lateral_West_Stop, pAgeInTicks, 1f);
        this.animate(pEntity.right_blazehattan_stop, BlazeTransferAnimations.Lateral_East_Stop, pAgeInTicks, 1f);
        this.animate(pEntity.forward_blazehattan_loop, BlazeTransferAnimations.Forward_North_Loop, pAgeInTicks, 1f);
        this.animate(pEntity.back_blazehattan_loop, BlazeTransferAnimations.Forward_South_Loop, pAgeInTicks, 1f);
        this.animate(pEntity.left_blazehattan_loop, BlazeTransferAnimations.Lateral_West_Loop, pAgeInTicks, 1f);
        this.animate(pEntity.right_blazehattan_loop, BlazeTransferAnimations.Lateral_East_Loop, pAgeInTicks, 1f);
        this.animate(pEntity.spinny_boi, BlazeTransferAnimations.Main_Spin, pAgeInTicks, 1f);
    }
