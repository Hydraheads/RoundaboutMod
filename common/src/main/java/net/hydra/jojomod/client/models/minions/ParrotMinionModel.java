...
public class ParrotMinionModel<T extends ParrotMinion> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public ParrotMinionModel(ModelPart $$0) {
        this.root = $$0;
