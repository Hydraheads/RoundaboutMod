...
public class PWMeteorModel <T extends PWMeteorEntity> extends HierarchicalModel<T> {
    ...
    public PWMeteorModel(ModelPart root) {
        ...
        this.layer = this.Fireball.getChild("layer");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Fireball = partdefinition.addOrReplaceChild("Fireball", CubeListBuilder.create().texOffs(12, 10).addBox(-2.0F, -3.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 2.5F, 0.5F));

        PartDefinition layer = Fireball.addOrReplaceChild("layer", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -4.0F, -3.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 10).addBox(-2.0F, -14.0F, -2.0F, 3.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public void setLayerRotation(float xRot, float x, float y, float z) {
        this.layer.xRot = xRot;
        this.layer.x = x;
        this.layer.y = y;
        this.layer.z = z;
    }
