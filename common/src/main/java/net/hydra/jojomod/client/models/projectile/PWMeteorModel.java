...
public class PWMeteorModel <T extends PWMeteorEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Fireball = partdefinition.addOrReplaceChild("Fireball", CubeListBuilder.create().texOffs(12, 10).addBox(-2.0F, -3.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
