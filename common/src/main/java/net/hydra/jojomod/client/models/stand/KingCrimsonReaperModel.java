...
public class KingCrimsonReaperModel<T extends ReaperKingCrimsonEntity> extends StandModel<T> {
	public KingCrimsonReaperModel(ModelPart root) {
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        this.animate(pEntity.finalPunchWindup, KingCrimsonAnimations.Chop_Start_REAPER, pAgeInTicks, 0.8f);
        this.animate(pEntity.finalPunch, StarPlatinumAnimations.FINAL_PUNCH, pAgeInTicks, 1.4f);
        this.animate(pEntity.finalPunch2, KingCrimsonAnimations.Chop_Attack_REAPER, pAgeInTicks, 1.4f);
        this.animate(pEntity.finalPunch3, KingCrimsonAnimations.Chop_Charged_REAPER, pAgeInTicks, 1.4f);
        this.animate(pEntity.impale2, StarPlatinumAnimations.Impale2, pAgeInTicks, 1.04f);
        this.animate(pEntity.hideScythe, KingCrimsonAnimations.scythe_off, pAgeInTicks, 1.04f);

        this.animate(pEntity.bloodSplashWindup, KingCrimsonAnimations.Chop_Start, pAgeInTicks, 1.6f);
        this.animate(pEntity.bloodSplashThrow, KingCrimsonAnimations.Chop_Attack, pAgeInTicks, 1.7f);
