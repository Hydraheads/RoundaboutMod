...
public class DogMinionRenderer extends MobRenderer<DogMinion, DogMinionModel<DogMinion>> {
    ...
    public DogMinionRenderer(EntityRendererProvider.Context $$0) {
        ...
        this.addLayer(new ItemInHandLayer<DogMinion, DogMinionModel<DogMinion>>(this, $$0.getItemInHandRenderer()) {
            public void render(PoseStack $$0, MultiBufferSource $$1, int $$2, DogMinion $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
                if ($$3.isAggressive()) {
