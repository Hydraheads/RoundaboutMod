...
public class BombPlantedItemEntityRenderer extends EntityRenderer<BombPlantedItemEntity> {
    private final ItemRenderer itemRenderer;
    private final RandomSource random = RandomSource.create();

    public BombPlantedItemEntityRenderer(EntityRendererProvider.Context $$0) {
        super($$0);
    ...
    public void render(BombPlantedItemEntity $$0, float $$1, float $$2, PoseStack $$3, MultiBufferSource $$4, int $$5) {
        $$3.pushPose();
    ...
    public ResourceLocation getTextureLocation(BombPlantedItemEntity $$0) {
