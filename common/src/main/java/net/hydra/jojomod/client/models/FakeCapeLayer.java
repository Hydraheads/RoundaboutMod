...
public class FakeCapeLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, PlayerModel<T>> {
    public FakeCapeLayer(RenderLayerParent<T, PlayerModel<T>> $$0) {
        super($$0);
    }
    ...
    public void render(PoseStack $$0, MultiBufferSource $$1, int $$2, LivingEntity liv, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
        ...
        if (liv instanceof CloneEntity ce && !(ce instanceof FogCloneEntity)){

            ItemStack visage;
            visage = ce.getVisage();
            if (visage != null && !visage.isEmpty()) {
                if (visage.getItem() instanceof MaskItem MI) {
                    VisageData vd = MI.visageData.generateVisageData(ce);
                    if (vd.isCharacterVisage()) {

                        if (vd.rendersCape()){
                            ItemStack $$10 = ce.getItemBySlot(EquipmentSlot.CHEST);
                            if (!$$10.is(Items.ELYTRA)) {
                                $$0.pushPose();
                                $$0.translate(0.0F, 0.0F, 0.125F);
                                double $$11 = Mth.lerp((double) $$6, ce.xCloakO, ce.xCloak) - Mth.lerp((double) $$6, ce.xo, ce.getX());
                                double $$12 = Mth.lerp((double) $$6, ce.yCloakO, ce.yCloak) - Mth.lerp((double) $$6, ce.yo, ce.getY());
                                double $$13 = Mth.lerp((double) $$6, ce.zCloakO, ce.zCloak) - Mth.lerp((double) $$6, ce.zo, ce.getZ());
                                float $$14 = Mth.rotLerp($$6, ce.yBodyRotO, ce.yBodyRot);
                                ...
                                float $$20 = Mth.lerp($$6, ce.oBob, ce.bob);
                                $$17 += Mth.sin(Mth.lerp($$6, ce.walkDistO, ce.walkDist) * 6.0F) * 32.0F * $$20;
                                if (ce.isCrouching()) {
                                    $$17 += 25.0F;
                                }
            ...
            if (ce.getPlayer() instanceof AbstractClientPlayer $$3) {
            if ($$3.isCapeLoaded() && !$$3.isInvisible() && $$3.isModelPartShown(PlayerModelPart.CAPE) && $$3.getCloakTextureLocation() != null) {
                ...
                if (!$$10.is(Items.ELYTRA)) {
                    ...
                    double $$13 = Mth.lerp((double) $$6, ce.zCloakO, ce.zCloak) - Mth.lerp((double) $$6, ce.zo, ce.getZ());
                    float $$14 = Mth.rotLerp($$6, ce.yBodyRotO, ce.yBodyRot);
                    double $$15 = (double) Mth.sin($$14 * ((float) Math.PI / 180F));
                    double $$16 = (double) (-Mth.cos($$14 * ((float) Math.PI / 180F)));
                    float $$17 = (float) $$12 * 10.0F;
                    $$17 = Mth.clamp($$17, -6.0F, 32.0F);
                    float $$18 = (float) ($$11 * $$15 + $$13 * $$16) * 100.0F;
                    $$18 = Mth.clamp($$18, 0.0F, 150.0F);
