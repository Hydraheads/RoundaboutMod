...
public class MinionStrollGoal extends RandomStrollGoal {
    public static final float PROBABILITY = 0.001F;
    protected final float probability;

    public MinionStrollGoal(PathfinderMob $$0, double $$1) {
        this($$0, $$1, 0.001F);
    }

    public MinionStrollGoal(PathfinderMob $$0, double $$1, float $$2) {
        super($$0, $$1);
        this.probability = $$2;
    }
    @Override
