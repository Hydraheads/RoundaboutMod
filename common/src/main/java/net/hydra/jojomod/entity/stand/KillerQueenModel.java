...
import net.hydra.jojomod.event.powers.stand.PowersKillerQueen;
...
public class KillerQueenModel<T extends KillerQueenEntity> extends StandModel<T>{
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head2 = head.addOrReplaceChild("head2", CubeListBuilder.create().texOffs(71, 0).addBox(-4.0F, -7.85F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-4.0F, -7.85F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition upper_right_arm = right_arm.addOrReplaceChild("upper_right_arm", CubeListBuilder.create().texOffs(24, 21).addBox(-4.0F, -0.75F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 41).addBox(-4.0F, -0.75F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.2F))
                .texOffs(-2, -2).mirror().addBox(-4.5F, -0.75F, -2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition lower_right_arm = right_arm.addOrReplaceChild("lower_right_arm", CubeListBuilder.create().texOffs(0, 26).addBox(-2.0F, -0.25F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 5.5F, 0.0F));

        PartDefinition left_arm = upper_chest.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offset(4.25F, -5.25F, 0.0F));

        PartDefinition upper_left_arm = left_arm.addOrReplaceChild("upper_left_arm", CubeListBuilder.create().texOffs(16, 31).addBox(0.0F, -0.75F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.01F))
                .texOffs(0, 46).addBox(0.0F, -0.75F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.2F))
                .texOffs(-2, -2).addBox(4.5F, -0.75F, -2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(67, 49).addBox(1.0F, 3.25F, 2.25F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition belt = lower_torso.addOrReplaceChild("belt", CubeListBuilder.create().texOffs(56, 20).addBox(-1.5F, -1.75F, -1.7F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.3F))
                .texOffs(32, 75).addBox(-4.5F, -1.65F, -1.45F, 9.0F, 2.0F, 5.0F, new CubeDeformation(-0.4F))
                .texOffs(64, 79).addBox(-1.5F, -0.25F, -1.5F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.3F, -1.0F));
        ...
        PartDefinition cube_r6 = RightArmBAM.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(14, 121).addBox(-10.75F, -4.25F, -5.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r7 = RightArmBAM2.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(14, 121).addBox(-5.5F, -4.25F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r8 = RightArmBAM3.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(14, 121).addBox(0.25F, -4.25F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r9 = LeftArmBAM.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(14, 121).mirror().addBox(-3.25F, -4.25F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r10 = LeftArmBAM4.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(14, 121).mirror().addBox(1.5F, -4.25F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r11 = LeftArmBAM3.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(14, 121).mirror().addBox(-4.25F, -4.25F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
