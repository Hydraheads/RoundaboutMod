...
public class BowlerHatFlyingSound extends AbstractTickableSoundInstance {
    private final Entity hatEntity;

    public BowlerHatFlyingSound(SoundEvent soundEvent, SoundSource category, float volume, float pitch, Entity entity) {
