...
public class RoadRollerMixingSound extends AbstractTickableSoundInstance {
    private final Entity hatEntity;

    public RoadRollerMixingSound(SoundEvent soundEvent, SoundSource category, float volume, float pitch, Entity entity) {
