...
public class RoadRollerAmbientSound extends AbstractTickableSoundInstance {
    private final Entity hatEntity;

    public RoadRollerAmbientSound(SoundEvent soundEvent, SoundSource category, float volume, float pitch, Entity entity) {
