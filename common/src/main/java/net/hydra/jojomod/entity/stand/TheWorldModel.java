...
public class TheWorldModel<T extends TheWorldEntity> extends StandModel<T> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition tanks = no_arms.addOrReplaceChild("tanks", CubeListBuilder.create().texOffs(65, 64).addBox(-3.5F, -23.0F, 2.0F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
