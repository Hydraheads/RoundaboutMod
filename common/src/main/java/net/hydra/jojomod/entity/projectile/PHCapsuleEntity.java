...
public class PHCapsuleEntity extends ThrowableProjectile implements UnburnableProjectile, PenetratableWithProjectile {
    public PHCapsuleEntity(EntityType<? extends PHCapsuleEntity> $$0, Level $$1) {
        super($$0, $$1);
    }
    ...
    private static final EntityDataAccessor<Boolean> ACTIVATED =
            SynchedEntityData.defineId(PHCapsuleEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Boolean> LAUNCHED =
            SynchedEntityData.defineId(PHCapsuleEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Float> SPEED =
            SynchedEntityData.defineId(PHCapsuleEntity.class, EntityDataSerializers.FLOAT);
    ...
    private static final EntityDataAccessor<Integer> USER_ID = SynchedEntityData.defineId(PHCapsuleEntity.class, EntityDataSerializers.INT);
    protected PHCapsuleEntity(EntityType<? extends PHCapsuleEntity> $$0, double $$1, double $$2, double $$3, Level $$4) {
        this($$0, $$4);
        this.setPos($$1, $$2, $$3);
    }
