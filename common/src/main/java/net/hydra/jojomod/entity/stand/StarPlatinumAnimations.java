...
public class StarPlatinumAnimations {
	...
	public static final AnimationDefinition BASEBALL_HIT = AnimationDefinition.Builder.withLength(0.125F)
			...
			.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-98.6435F, 66.3849F, -48.632F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0417F, KeyframeAnimations.degreeVec(-80.93F, -9.73F, -12.93F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-109.5788F, -47.7895F, 4.9265F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.124F, KeyframeAnimations.degreeVec(-109.5788F, -47.7895F, 4.9265F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(-108.6945F, -59.3319F, 13.1055F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
					new Keyframe(0.0833F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("lower_right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 37.5F, -95.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0417F, KeyframeAnimations.degreeVec(74.814F, 82.5708F, 64.1248F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(12.0F, 81.4083F, -14.2474F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.124F, KeyframeAnimations.degreeVec(12.0F, 81.4083F, -14.2474F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(10.0F, -67.4061F, 17.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-112.8764F, 74.5216F, -48.9095F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0417F, KeyframeAnimations.degreeVec(-74.1898F, 42.703F, -5.7631F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-63.075F, 18.763F, -46.6826F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.124F, KeyframeAnimations.degreeVec(-63.075F, 18.763F, -46.6826F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(-103.1458F, 29.0294F, -82.5936F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.124F, KeyframeAnimations.posVec(0.0F, 0.0F, 1.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("lower_left_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0417F, KeyframeAnimations.degreeVec(-81.1256F, 60.4418F, -79.8238F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-112.7233F, 27.6019F, 86.6514F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.124F, KeyframeAnimations.degreeVec(-112.7233F, 27.6019F, 86.6514F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(-159.6021F, -30.5266F, 156.7442F), AnimationChannel.Interpolations.LINEAR)
			))
			...
			.addAnimation("right_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.125F, KeyframeAnimations.posVec(0.5F, 0.0F, -1.75F), AnimationChannel.Interpolations.LINEAR)
			))
			...
			.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.125F, KeyframeAnimations.posVec(-0.75F, 0.0F, 2.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.build();
