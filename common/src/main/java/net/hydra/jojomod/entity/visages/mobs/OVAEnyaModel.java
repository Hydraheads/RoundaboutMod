...
public class OVAEnyaModel<T extends OVAEnyaNPC> extends PlayerLikeModel<T> {
    public OVAEnyaModel(ModelPart root) {
        ...
        this.jacket = playerlike.getChild("upper_body").getChild("jacket");
        this.body = playerlike.getChild("upper_body").getChild("body");
        this.leftArm = playerlike.getChild("upper_body").getChild("left_arms").getChild("left_arm");
        this.rightArm = playerlike.getChild("upper_body").getChild("right_arms").getChild("right_arm");
        this.leftSleeve = playerlike.getChild("upper_body").getChild("left_arms").getChild("left_sleeve");
        this.rightSleeve = playerlike.getChild("upper_body").getChild("right_arms").getChild("right_sleeve");
        this.leftLeg = playerlike.getChild("legs").getChild("left_legs").getChild("left_leg");
        this.rightLeg = playerlike.getChild("legs").getChild("right_legs").getChild("right_leg");
        this.leftPants = playerlike.getChild("legs").getChild("left_legs").getChild("left_pants");
        this.rightPants = playerlike.getChild("legs").getChild("right_legs").getChild("right_pants");
        this.cloak = playerlike.getChild("upper_body").getChild("cloak");
    }
...
@Override
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition upper_body = playerlike.addOrReplaceChild("upper_body", CubeListBuilder.create(), PartPose.offset(0.0F, -13.0F, 0.0F));
        ...
        PartDefinition right_arm = right_arms.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.5F, -1.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_sleeve = right_arms.addOrReplaceChild("right_sleeve", CubeListBuilder.create().texOffs(40, 32).addBox(-3.5F, -1.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition legs = playerlike.addOrReplaceChild("legs", CubeListBuilder.create(), PartPose.offset(-5.0F, -24.0F, 0.0F));
