...
public class TheWorldUltimateModel<T extends TheWorldEntity> extends StandModel<T> {
	public TheWorldUltimateModel(ModelPart root) {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition top2 = extra_details2.addOrReplaceChild("top2", CubeListBuilder.create().texOffs(63, 45).addBox(-5.0F, -0.6114F, 0.9698F, 10.0F, 2.0F, 2.0F, new CubeDeformation(0.249F))
				.texOffs(0, 73).addBox(-5.0F, -0.6F, -5.0302F, 10.0F, 2.0F, 8.0F, new CubeDeformation(0.2501F)), PartPose.offset(0.0F, -0.1F, 0.0F));
		...
		PartDefinition upper_right_arm = right_arm.addOrReplaceChild("upper_right_arm", CubeListBuilder.create().texOffs(16, 53).addBox(-4.0F, -0.75F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(60, 23).addBox(-4.0F, -0.75F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.2F))
		...
		PartDefinition upper_left_arm = left_arm.addOrReplaceChild("upper_left_arm", CubeListBuilder.create().texOffs(48, 30).addBox(0.0F, -0.75F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.01F))
				.texOffs(0, 59).addBox(0.0F, -0.75F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.2F))
