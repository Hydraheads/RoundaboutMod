...
public class unknownAnimation {
	public static final AnimationDefinition CrossPunch WindUp = AnimationDefinition.Builder.withLength(0.8333F)
		...
		.addAnimation("right_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, -4.25F, 4.25F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, -3.0F, 5.25F), AnimationChannel.Interpolations.CATMULLROM)
		))
	...
	public static final AnimationDefinition CrossPunch Release = AnimationDefinition.Builder.withLength(0.6F)
		.addAnimation("stand2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition CrossPunch Release V2 = AnimationDefinition.Builder.withLength(0.6F)
		.addAnimation("stand2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.0889F, KeyframeAnimations.degreeVec(20.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.2222F, KeyframeAnimations.degreeVec(12.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
