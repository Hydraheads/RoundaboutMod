...
public class unknown<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(52, 0).addBox(4.0F, -24.1F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		.texOffs(56, 16).addBox(-0.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.17F)), PartPose.offset(0.0F, 12.0F, 0.0F));
