...
public class unknown<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArmArmor = Armor.addOrReplaceChild("LeftArmArmor", CubeListBuilder.create().texOffs(40, 26).addBox(4.0F, -24.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F))
		.texOffs(52, 0).addBox(4.0F, -24.1F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition RightArmArmor = Armor.addOrReplaceChild("RightArmArmor", CubeListBuilder.create(), PartPose.offset(-5.0F, 2.0F, 0.0F));
