...
public class manhattan_transfer<T extends Entity> extends EntityModel<T> {
	...
	public manhattan_transfer(ModelPart root) {
		this.stand = root.getChild("stand");
		this.core = this.stand.getChild("core");
		this.mangacores = this.core.getChild("mangacores");
		this.key_string1 = this.stand.getChild("key_string1");
		this.key = this.key_string1.getChild("key");
		this.key_string2 = this.stand.getChild("key_string2");
		this.key2 = this.key_string2.getChild("key2");
		this.front_wing = this.stand.getChild("front_wing");
		this.front_flap = this.front_wing.getChild("front_flap");
		this.front_petals = this.front_wing.getChild("front_petals");
		this.front_flower = this.front_wing.getChild("front_flower");
		this.right_wing = this.stand.getChild("right_wing");
		...
		this.left_wing = this.stand.getChild("left_wing");
		this.left_flap = this.left_wing.getChild("left_flap");
		this.left_petals = this.left_wing.getChild("left_petals");
		this.left_flower = this.left_wing.getChild("left_flower");
		this.back_wing = this.stand.getChild("back_wing");
		this.back_flap = this.back_wing.getChild("back_flap");
		this.back_petals = this.back_wing.getChild("back_petals");
		this.back_flower = this.back_wing.getChild("back_flower");
	}
