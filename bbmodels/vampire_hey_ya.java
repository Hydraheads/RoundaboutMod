...
public class vampire_hey_ya<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "vampire_hey_ya"), "main");
	...
	public vampire_hey_ya(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(50, 32).addBox(-3.3772F, -0.8F, -6.825F, 7.0F, 1.0F, 0.0F, new CubeDeformation(-0.01F))
