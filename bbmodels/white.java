...
public class unknown<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Details_r1 = Helmet.addOrReplaceChild("Details_r1", CubeListBuilder.create().texOffs(33, 67).addBox(-1.5F, -3.0F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1301F, -30.8112F, 0.0F, 0.0F, 0.0F, -1.1345F));

		PartDefinition Details_r2 = Helmet.addOrReplaceChild("Details_r2", CubeListBuilder.create().texOffs(33, 67).mirror().addBox(-1.5F, -3.0F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.1301F, -30.8112F, 0.0F, 0.0F, 0.0F, 1.1345F));

		PartDefinition Chestplate = Armor.addOrReplaceChild("Chestplate", CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.15F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		.texOffs(56, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.17F)), PartPose.offset(-1.9F, 12.0F, 0.0F));

		PartDefinition LeftLegArmor = Armor.addOrReplaceChild("LeftLegArmor", CubeListBuilder.create().texOffs(40, 42).addBox(-0.1F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F))
		.texOffs(56, 16).addBox(-0.1F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.17F)), PartPose.offset(0.0F, 24.0F, 0.0F));
