...
public class white_album_left_leg<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition limb = partdefinition.addOrReplaceChild("limb", CubeListBuilder.create().texOffs(40, 42).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.26F))
