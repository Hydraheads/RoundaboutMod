...
public class unknown extends EntityModel<Entity> {
	...
	private final ModelPart left_hand_1;
	...
	public unknown(ModelPart root) {
		...
		this.left_hand_1 = root.getChild("left_hand_1");
		...
		this.left_hand_2 = root.getChild("left_hand_2");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData left_hand_1 = modelPartData.addChild("left_hand_1", ModelPartBuilder.create().uv(40, 53).cuboid(-2.0F, -7.0F, -4.0F, 4.0F, 3.0F, 8.0F, new Dilation(0.0F)), ModelTransform.of(9.4603F, 3.119F, -5.7865F, -1.747F, -0.4488F, -1.1814F));

		ModelPartData right_finger = left_hand_1.addChild("right_finger", ModelPartBuilder.create().uv(6, 40).cuboid(0.2034F, 0.1876F, -1.05F, 1.0F, 6.0F, 2.0F, new Dilation(0.18F)), ModelTransform.of(-0.1909F, -4.6349F, -2.1281F, 0.0F, 0.0F, 0.1309F));
		...
		ModelPartData left_finger = left_hand_1.addChild("left_finger", ModelPartBuilder.create().uv(10, 46).cuboid(0.2034F, 0.1876F, -1.05F, 1.0F, 6.0F, 2.0F, new Dilation(0.18F)), ModelTransform.of(-0.1909F, -4.6349F, 2.6219F, 0.0F, 0.0F, 0.1309F));
		...
		ModelPartData middle_finger = left_hand_1.addChild("middle_finger", ModelPartBuilder.create().uv(4, 48).cuboid(0.2034F, 0.1876F, -1.05F, 1.0F, 6.0F, 2.0F, new Dilation(0.18F)), ModelTransform.pivot(-0.1909F, -4.6349F, 0.2469F));
		...
		ModelPartData thumb = left_hand_1.addChild("thumb", ModelPartBuilder.create().uv(8, 54).cuboid(0.0747F, 0.1958F, -0.9206F, 1.0F, 5.0F, 2.0F, new Dilation(0.2F))
		.uv(17, 46).cuboid(1.3F, 3.7F, -0.925F, 0.0F, 2.0F, 2.0F, new Dilation(0.0F))
		.uv(18, 49).cuboid(1.3F, 5.701F, -0.3965F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.175F, -4.3F, -2.15F, -0.3491F, 0.0F, 0.5672F));

		ModelPartData left_hand_2 = modelPartData.addChild("left_hand_2", ModelPartBuilder.create().uv(40, 53).cuboid(-2.0F, -7.0F, -4.0F, 4.0F, 3.0F, 8.0F, new Dilation(0.0F)), ModelTransform.of(-9.5397F, 3.119F, -5.7865F, -1.3742F, -0.4407F, -2.0077F));

		ModelPartData right_finger2 = left_hand_2.addChild("right_finger2", ModelPartBuilder.create().uv(6, 40).cuboid(0.2034F, 0.1876F, -1.05F, 1.0F, 6.0F, 2.0F, new Dilation(0.18F)), ModelTransform.of(-0.1909F, -4.6349F, -2.1281F, 0.0F, 0.0F, 0.1309F));
		...
		ModelPartData left_finger2 = left_hand_2.addChild("left_finger2", ModelPartBuilder.create().uv(10, 46).cuboid(0.2034F, 0.1876F, -1.05F, 1.0F, 6.0F, 2.0F, new Dilation(0.18F)), ModelTransform.of(-0.1909F, -4.6349F, 2.6219F, 0.0F, 0.0F, 0.1309F));
		...
		ModelPartData middle_finger2 = left_hand_2.addChild("middle_finger2", ModelPartBuilder.create().uv(4, 48).cuboid(0.2034F, 0.1876F, -1.05F, 1.0F, 6.0F, 2.0F, new Dilation(0.18F)), ModelTransform.pivot(-0.1909F, -4.6349F, 0.2469F));
		...
		ModelPartData thumb2 = left_hand_2.addChild("thumb2", ModelPartBuilder.create().uv(8, 54).cuboid(0.0747F, 0.1958F, -0.9206F, 1.0F, 5.0F, 2.0F, new Dilation(0.2F))
		.uv(17, 46).cuboid(1.3F, 3.7F, -0.925F, 0.0F, 2.0F, 2.0F, new Dilation(0.0F))
		.uv(18, 49).cuboid(1.3F, 5.701F, -0.3965F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.175F, -4.3F, -2.15F, -0.3491F, 0.0F, 0.5672F));
	...
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		...
		left_hand_1.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
		left_hand_2.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}
}